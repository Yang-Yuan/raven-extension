...
def max_size_injective_mapping(PR, order):
    """
...
def soft_jaccard_map(A_coms, B_coms):
    ...
    A_ids, B_ids, level = max_size_injective_mapping(all_jc, lambda a, b: a >= b)
...
def delta_location_map(A_coms, B_coms, C_coms, D_coms,
    ...
    AB_loc_diff_ids, CD_loc_diff_ids, level = max_size_injective_mapping(dist, lambda a, b: a <= b)
...
def delta_shape_map(A_coms, B_coms, C_coms, D_coms,
    ...
    AB_jaccard_diff_ids, CD_jaccard_diff_ids, level = max_size_injective_mapping(dist, lambda a, b: a <= b)
