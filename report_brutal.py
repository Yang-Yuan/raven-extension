...
report_folder = "./reports/brutal"


# TODO improve this part with pandas or other framework


def create_report_brutal_mode(problems):
    file_name = "raven_brutal_" + datetime.now().strftime("%d_%m_%Y_%H_%M_%S") + ".xlsx"
